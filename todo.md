...
## Bug Fixes - Round 4
- [x] إصلاح: إرسال الفاتورة عبر واتساب - إصلاح منطق sendWhatsApp ليستخدم instance مباشرة + إظهار رسالة خطأ واضحة
- [x] إصلاح: الباركود في الفاتورة - إضافة تأخير 300ms ومؤشر تحميل وخلفية بيضاء
